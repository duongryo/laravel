                            ...
                            <tr>
                                <td class="o_bg-white o_px-md o_py o_sans o_text o_text-secondary" align="left"
                                    ...
                                    <p
                                        ...
                                        {{ $user->email }} ơi, gói thành viên của bạn sẽ <span style="color:#FF3B30">hết hạn </span>trong
                                        hôm nay
                                        </span>:((
                                    </p>
                                    <p style="color:#333333; font-size:14px;line-height: 20px;">
                                        Hãy nhanh tay gia hạn/nâng cấp để tiếp tục những việc vẫn còn dang dở của mình ngày
                                        nào.
                                    </p>
