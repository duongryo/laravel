                    ...
                    <div class="rsolution-card-body">
                        <div class="row">
                            ...
                            <div class="col-auto">
                                ...
                                <a class="btn btn-white btn-icon" href="{{ route('rcms.product.index') }}">
                ...
                <div class="rsolution-card-shadow">
                    ...
                    <div class="rsolution-card-header border-bottom">
                        <div class="row d-flex align-items-center">
                            <div class="col">
                                <h6 class="m-0">List Product</h6>
                            </div>
                            <div class="col-auto">
                                <a class="btn btn-primary btn-sm" href="{{ route('rcms.product.create') }}"><i
                        ...
                        <table class="table border rsolution-table">
                            <thead>
                                <tr class="align-middle">
                                    ...
                                    <th class="text-center" width="15%">Display Order</th>
                                ...
                                @else
                                    @foreach ($data as $key => $item)
                                        <tr>
                                            ...
                                            <td width="15%">
                                                <img width="100px" src="{{ env('APP_URL') . $item->logo }}"
                                                    alt="">
                                            </td>
                                            ...
                                            <td class="text-center" style="width: 15%">
                                                <select name="status" id-product="{{ $item->id }}"
                                            ...
                                            <td class="text-right">
                                                <a class="btn btn-light btn-sm btn-icon"
                                                    href="{{ route('rcms.product.edit', $item->id) }}"><i
...
@section('js')
    <script>
        ...
        $('[data-target="status"]').change(function() {
            ...
            $.ajax({
                type: "PATCH",
                url: "/rcms/product/" + id + "/update-fillable",
                data: {
                    _token: $('input[name=_token]').val(),
                    id: id,
                    field: 'status',
